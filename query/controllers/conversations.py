...
def create_conversation_controller(payload: CreateConversationRequest, user_id: int):
    return create_conversation(user_id=user_id, title=payload.title)


def list_conversations_controller(user_id: int):
    return {"conversations": list_conversations(user_id)}


def get_conversation_controller(conversation_id: int, user_id: int):
    try:
...
def delete_conversation_controller(conversation_id: int, user_id: int):
    try:
