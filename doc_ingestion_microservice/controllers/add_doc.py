...
from rag_project.doc_ingestion_microservice.dto.Doc_dto import AddDocRequest
from fastapi import HTTPException
from rag_project.doc_ingestion_microservice.tasks.ingest_tasks import ingest_document
