...
from rag_project.query_service.config.db import qdrant

from rag_project.query_service.llmops.config_loader import load_config
from rag_project.query_service.llmops.model_router import ModelRouter
from rag_project.query_service.llmops.guardrails import sanitize_input, validate_llm_output
...
async def run_query(
    ...
    embedding = await asyncio.to_thread(embeddings.embed_query, clean_user_query)
