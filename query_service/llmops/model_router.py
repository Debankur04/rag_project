...
from rag_project.query_service.controllers.add_intent import insert_intent
...
class ModelRouter:
    ...
    def select_model(self, query: str, user_tier: str = "standard", db=None) -> str:
        ...
        if rules.get("use_intent_classifier", False):
            from rag_project.query_service.llmops.intent_classifier import IntentClassifier
